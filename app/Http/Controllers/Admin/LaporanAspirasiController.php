...
class LaporanAspirasiController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = LaporanPengaduan::with(['kategoriAspirasi', 'aspirasi', 'reporter', 'siswa'])
            ->latest();
    ...
    public function show(LaporanPengaduan $laporan)
    {
        ...
        $laporan->load(['kategoriAspirasi', 'aspirasi', 'komentar.sender', 'reporter', 'siswa']);
    ...
    public function cetakPdf(Request $request)
    {
        ...
        $query = LaporanPengaduan::with(['kategoriAspirasi', 'siswa', 'reporter', 'aspirasi']);
