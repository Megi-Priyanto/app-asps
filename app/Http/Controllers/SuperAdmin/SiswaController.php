...
class SiswaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('superadmin.pengguna.siswa.index', compact('siswas'));
    }

    public function create()
    {
        return view('superadmin.pengguna.siswa.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin.pengguna.siswa.index')
