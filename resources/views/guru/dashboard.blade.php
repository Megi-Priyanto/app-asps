...
<div class="welcome-banner">
    <div style="position:relative;z-index:1;">
        <div class="welcome-banner-title">Halo, {{ $guru->nama ?? 'Guru' }}! 👋</div>
    ...
    <i class="bi bi-book-fill welcome-banner-icon d-none d-md-block"></i>
</div>
...
<div class="chart-card mb-4">
    <div class="chart-card-header">
        ...
        <a href="{{ route('guru.laporan.index') }}" class="btn btn-sm btn-primary" style="font-size:12px;">
        ...
        <table class="act-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('guru.laporan.show', $item->id) }}" class="btn btn-sm btn-primary" style="font-size:11.5px; padding:4px 12px;">Detail</a>
                    </td>
                </tr>
                @empty
                <tr>
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
        <a href="{{ route('guru.laporan.create') }}" class="quick-link">
    ...
    <div class="col-6 col-md-3">
        <a href="{{ route('guru.laporan.index') }}" class="quick-link">
    ...
    <div class="col-6 col-md-3">
        <a href="{{ route('guru.peminjaman-barang.index') }}" class="quick-link">
    ...
    <div class="col-6 col-md-3">
        <a href="{{ route('guru.akun') }}" class="quick-link">
