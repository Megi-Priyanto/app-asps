...
<div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('guru.peminjaman-barang.create') }}" class="btn btn-primary btn-sm">
    ...
    <div class="card-body p-0">
        @if($peminjamans->isEmpty())
            <div class="text-center py-5" style="color:#94A3B8;">
                ...
                <div style="font-size:13px;">Klik tombol <strong>Buat Permintaan</strong> untuk meminjam barang.</div>
                <a href="{{ route('guru.peminjaman-barang.create') }}" class="btn btn-primary btn-sm mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size:12.5px;">
                            ...
                            @if($p->terlambat)
                                <br><small class="text-danger"><i class="bi bi-clock me-1"></i>Terlambat {{ $p->hari_terlambat }} hari</small>
                            @endif
                        </td>
                        <td>
