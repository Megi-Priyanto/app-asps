...
<div class="welcome-banner">
    <div style="position:relative;z-index:1;">
        <div class="welcome-banner-title">Halo, {{ $siswa->nama ?? 'Siswa' }}! 👋</div>
    ...
    <i class="bi bi-mortarboard-fill welcome-banner-icon d-none d-md-block"></i>
</div>
...
<div class="chart-card mb-4">
    <div class="chart-card-header">
        ...
        <a href="{{ route('siswa.laporan.index') }}" class="btn btn-sm btn-primary" style="font-size:12px;">
        ...
        <table class="act-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('siswa.laporan.show', $item->id) }}" class="btn btn-sm btn-primary" style="font-size:11.5px; padding:4px 12px;">Detail</a>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="6" class="text-center py-4" style="color:var(--text-muted); font-size:13px;">
                        <i class="bi bi-inbox me-2"></i>Belum ada laporan. Mulai buat laporan pertamamu!
                    </td>
                </tr>
                @endforelse
            </tbody>
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
        <a href="{{ route('siswa.laporan.create') }}" class="quick-link">
    ...
    <div class="col-6 col-md-3">
        <a href="{{ route('siswa.laporan.index') }}" class="quick-link">
    ...
    <div class="col-6 col-md-3">
        <a href="{{ route('siswa.peminjaman-barang.index') }}" class="quick-link">
    ...
    <div class="col-6 col-md-3">
        <a href="{{ route('siswa.akun.edit') }}" class="quick-link">
