...
<div class="d-flex align-items-center gap-3 mb-4">
    <a href="{{ route('siswa.peminjaman-barang.index') }}" class="btn btn-sm" style="background:#F1F5F9;border:1px solid #E8EDF5;color:#64748B;border-radius:10px;">
    ...
    <div class="col-lg-7">
        <div class="card">
            ...
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('siswa.peminjaman-barang.store') }}" id="formPeminjaman">
                    @csrf
                    <div class="mb-3">
