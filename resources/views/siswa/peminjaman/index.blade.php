...
<div class="page-header">
    ...
    <a href="{{ route('siswa.peminjaman-barang.create') }}" class="btn btn-primary">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('siswa.peminjaman-barang.show', $p) }}" class="btn btn-sm" style="background:#EFF6FF;color:#2563EB;border:none;border-radius:6px;padding:5px 12px;font-size:12px;font-weight:600;"><i class="bi bi-eye me-1"></i>Detail</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
