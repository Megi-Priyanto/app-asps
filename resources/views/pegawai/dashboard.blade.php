...
<div class="welcome-banner">
    <div>
        ...
        <p>{{ \Carbon\Carbon::now()->translatedFormat('l, d F Y') }} &nbsp;•&nbsp; Pegawai</p>
    </div>
        ...
        <div class="card-body">
            ...
            @if(count($laporanTerbaru) > 0)
                <div class="text-center mt-3">
                    <a href="{{ route('pegawai.laporan.create') }}" class="btn btn-sm btn-primary px-3" style="border-radius:20px; font-weight:700; font-size:12px;">
