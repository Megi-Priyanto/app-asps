...
<div class="welcome-banner">
    <div>
        ...
        <p>{{ \Carbon\Carbon::now()->translatedFormat('l, d F Y') }} &nbsp;Â·&nbsp; {{ Auth::guard('pegawai')->user()->jabatan ?? 'Pegawai' }}</p>
    </div>
...
<div class="two-col">
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('pegawai.laporan.index') }}" class="header-link">Lihat semua â†’</a>
        </div>
        <div class="card-body">
