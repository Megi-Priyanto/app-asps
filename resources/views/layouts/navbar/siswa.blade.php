...
<nav class="apss-bottom-nav" id="apssBottomNav">
    <div class="bottom-nav-inner">
        ...
        <a href="{{ route('siswa.laporan.index') }}" class="bottom-nav-item {{ request()->routeIs('siswa.laporan.*') ? 'active' : '' }}">
            <i class="bi bi-file-earmark-text-fill"></i>
            <span>Laporan</span>
        </a>
        <a href="{{ route('siswa.peminjaman-barang.index') }}" class="bottom-nav-item {{ request()->routeIs('siswa.peminjaman-barang.*') ? 'active' : '' }}">
            <i class="bi bi-box-seam-fill"></i>
            <span>Peminjaman</span>
        </a>
        <a href="{{ route('siswa.tanggapan.index') }}" class="bottom-nav-item {{ request()->routeIs('siswa.tanggapan.*') ? 'active' : '' }}">
            <i class="bi bi-chat-left-text-fill"></i>
            <span>Tanggapan</span>
        </a>
        <a href="{{ route('siswa.akun.edit') }}" class="bottom-nav-item {{ request()->routeIs('siswa.akun.*') ? 'active' : '' }}">
