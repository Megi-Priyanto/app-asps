                        ...
                        <tr class="{{ $item->is_tampil ? 'bg-light' : '' }}">
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <form action="{{ route('superadmin.tanggapan-pengguna.toggle-status', $item->id) }}" method="POST">
                                        @csrf
                                    ...
                                    <form action="{{ route('superadmin.tanggapan-pengguna.destroy', $item->id) }}" method="POST"
