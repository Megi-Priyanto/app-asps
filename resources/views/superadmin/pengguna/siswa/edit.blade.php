...
<div class="card" style="max-width:600px;">
    ...
    <div class="card-body p-4">
        ...
        <form action="{{ route('superadmin.pengguna.siswa.update', $siswa->id) }}" method="POST">
            @csrf @method('PUT')

            <div class="mb-3">
                <label class="form-label">NIS <span class="text-danger"></span></label>
                <input type="number" name="nis" class="form-control @error('nis') is-invalid @enderror"
                    value="{{ old('nis', $siswa->nis) }}" required maxlength="10">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kelas" class="form-control @error('kelas') is-invalid @enderror"
                    value="{{ old('kelas', $siswa->kelas) }}" required maxlength="20">
