...
<div class="card" style="max-width:600px;">
    ...
    <div class="card-body p-4">
        ...
        <form action="{{ route('superadmin.pengguna.pegawai.update', $pegawai->id) }}" method="POST">
            @csrf @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="username" class="form-control @error('username') is-invalid @enderror"
                    value="{{ old('username', $pegawai->username) }}" required maxlength="20">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="jabatan" class="form-control @error('jabatan') is-invalid @enderror"
                    value="{{ old('jabatan', $pegawai->jabatan) }}" placeholder="Max 50 karakter" maxlength="50">
